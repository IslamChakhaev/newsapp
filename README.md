# 📰 News-portal — REST API для новостного сервиса

##  Описание

**News-portal** — это backend-приложение на Spring Boot, предоставляющее REST API для управления новостями, пользователями, категориями и комментариями. Поддерживает валидацию данных, защиту операций через AOP, фильтрацию и пагинацию.
